  ...
  return (
    <div className="ticket-list">
      ...
      <table>
        ...
        <tbody>
          {rows.map((t) => (
            <tr key={t.id} className={t.is_breached ? 'row-breached' : ''}>
              <td>{t.id}</td>
              ...
              <td>
                {t.is_breached ? (
                  <span className="badge badge-breached" title={`Exceeded ${t.sla_target_hours}h SLA target`}>
                    Breached
                  </span>
                ) : (
